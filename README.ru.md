...
Запустить виртуальное окружение и выполнить команду ```pip install -r requirements.txt```
...
Для указания конкретного раздела в канале используй соответствующее поле. 
