...
def initialize(rhapi):
    ...
    rhapi.events.on(Evt.RACE_STAGE, handler.check_battery)  # Check battery before race start
    ...
    rhapi.events.on(Evt.HEARTBEAT, handler.battery_heartbeat)  # Periodic battery check
    rhapi.server.enable_heartbeat_event()  # Enable heartbeat events
